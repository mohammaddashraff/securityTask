...
1	2023-11-16	12:30:00	19:30:00	2	f
\.
...
COPY public."patientAppointment" (appointmentid, doctorid, scheduleid, patientid, appointmentdate, starttime) FROM stdin;
2	2	1	1	2023-11-16	12:30:00
\.
...
SELECT pg_catalog.setval('public."DoctorsShedule_scheduleid_seq"', 2, true);
...
SELECT pg_catalog.setval('public."patientAppointment_appointmentid_seq"', 2, true);
...
--
-- Name: patientAppointment patientAppointment_appointmentid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."patientAppointment"
    ADD CONSTRAINT "patientAppointment_appointmentid_fkey" FOREIGN KEY (appointmentid) REFERENCES public."DoctorsSchedule"(scheduleid);


--
-- Name: patientAppointment patientAppointment_doctorid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."patientAppointment"
    ADD CONSTRAINT "patientAppointment_doctorid_fkey" FOREIGN KEY (doctorid) REFERENCES public."user"(userid);
